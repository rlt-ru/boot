...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  */
    ...
    */
    ...
    handle_GPDMA1_Channel9.Init.Request = GPDMA1_REQUEST_I2C3_RX;
    ...
    __HAL_LINKDMA(i2cHandle, hdmarx, handle_GPDMA1_Channel9);
    ...
    handle_GPDMA1_Channel8.Init.Request = GPDMA1_REQUEST_I2C3_TX;
    ...
    __HAL_LINKDMA(i2cHandle, hdmatx, handle_GPDMA1_Channel8);
